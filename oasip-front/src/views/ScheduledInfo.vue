    ...
    <div>
        ...
        <div class="l-w-10-12 mx-auto mb-8 grid grid-cols-2" v-if="(!modifyMode)">
            ...
            <div class="justify-self-end space-x-6 text-sm place-items-center">
                <button @click="modifyMode = true" :disable="eventInfoById.statusName == 'COMPLETED'"
                    class="w-20 h-8 border border-blue-600 text-blue-600 hover:bg-blue-600 hover:text-white duration-150 disabled:bg-gray-400 disabled:border disabled:text-gray-400">Edit</button>
