<template>
    <div class="l-w-824 mx-auto mt-12 scroll-smooth" id="top">
        ...
        <div class="l-w-400 grid gap-4">
            ...
            <p class="font-light text-sm l-color-gray-300">This page for editing category information. You can change
                the name, duration, and description of a category.</p>
        ...
        <div class="l-w-824 mx-auto mt-12 grid grid-cols-4 gap-6 mb-16">
            <a href="#edit" v-for="value, index in CLINICS" :key="index"
                ...
                <div class="w-32 h-32 grid place-items-center">
                    ...
                    <p class="text-sm text-center truncate w-32">{{ value.eventCategoryName }}</p>
                </div>
            </a>
        </div>
        <div class="l-w-824 h-96 mx-auto" v-if="CURR_DATA" id="edit">
            ...
            <div id="alert" class="mb-12">
                <div v-if="SUCCESFUL"
                    ...
                    <div>
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                            aria-hidden="true" role="img" class="iconify iconify--clarity mr-2" width="24" height="24"
                    ...
                    <div>
                        <span class="font-medium">DONE!</span> Update succesfully.
                    </div>
                </div>
                <div v-if="ERROR"
                    ...
                    role="alert">
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                        aria-hidden="true" role="img" class="iconify iconify--material-symbols mr-2" width="24"
            ...
            <div class="grid grid-cols-2 gap-6 gap-y-12">
                ...
                <!-- Input - Clinic name -->
                <div class="relative">
                    <input type="text" id="name" v-model="clinic_name.value" @input="clinicNameValidate"
                ...
                <!-- Input - Description -->
                <div class="relative">
                    <textarea type="text" id="description" maxlength="500" v-model="clinic_desc.value"
            ...
            <div class="flex gap-6">
                ...
                <button @click="CURR_CLINIC = 0"
                    class="my-12 bg-white text-red-600 l-w-188 h-12 border border-red-600 duration-150 hover:bg-rose-600 hover:text-white">Discard</button>
            </div>
