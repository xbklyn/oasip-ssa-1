        ...
        <div class="h-24 bg-white mt-24 mx-auto sticky top-0 z-50 grid place-items-center">
            <div class="l-w-full h-6 grid grid-cols-3 gap-6 mx-auto place-items-center">
                ...
                <div class="l-w-188 h-6">
                    <select class="l-w-188 border border-gray-300 text-sm l-color-gray-300 pl-2 py-1 focus:outline-none focus:ring-0 focus:border-blue-500" v-model="filter">
                ...
                <div class="flex gap-6">
                    <button @click="status = ''" :class="['grid justify-center place-items-center w-12 h-8 text-sm font-light l-color-navi duration-75',
                    status == '' ? 'border-b-2 border-blue-500 text-blue-500' : 'hover:border-gray-300 hover:border-b-2']">
                        All
                    </button>
                    <button @click="status = 'upcoming'" :class="['grid justify-center place-items-center w-28 h-8 text-sm font-light l-color-navi duration-75',
                    status == 'upcoming' ? 'border-b-2 border-blue-500 text-blue-500' : 'hover:border-gray-300 hover:border-b-2']">
                        Upcoming
                    </button>
                    <button @click="status = 'ongoing'" :class="['grid justify-center place-items-center w-28 h-8 text-sm font-light l-color-navi duration-75',
                    status == 'ongoing' ? 'border-b-2 border-blue-500 text-blue-500' : 'hover:border-gray-300 hover:border-b-2']">
                        On going
                    </button>
                    <button @click="status = 'completed'" :class="['grid justify-center place-items-center w-28 h-8 text-sm font-light l-color-navi duration-75',
                ...
                <div class="l-w-188 h-6">
                    <input type="date" class="pl-2 py-1 l-w-188 border l-color-gray-300 text-sm l-color-gray-300 focus:outline-none focus:ring-0 focus:border-blue-500" />
                </div>
