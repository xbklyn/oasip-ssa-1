<template>
    <div class="space-y-12" v-if="(data)">
        <div class="l-w-10-12 mx-auto" v-for="(value, index) in data" :key="index" >
            <div>
                <div class="h-32 flex place-items-center space-x-6">
                    ...
                    <div class="flex l-w-840 h-32 bg-white rounded-xl place-items-center ease-out transition hover:scale-110">
                        ...
                        <div class="ml-12 l-w-720 h-20 place-items-center">
                            ...
                            <div>
                                <p class="text-xs font-regular mt-1 text-slate-400">
