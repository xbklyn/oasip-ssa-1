<template>
  ...
  >
    ...
    <!-- Booking && Manage -->
    <div class="grid grid-cols-3 justify-self-end gap-x-6 mr-24">
      ...
      <router-link :to="{ name: 'Login' }" class="flex place-items-center">
        <button
      ...
      >
        <button
          class="flex gap-x-1 w-28 h-12 text-sm font-light place-items-center text-blue-600 duration-150 hover:text-blue-300"
        >
